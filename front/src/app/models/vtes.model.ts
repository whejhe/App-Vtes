export interface Card {
  ...
  burn_option?:     boolean;
  IconDisciplines:  IconDisciplines[];
}
...
export enum IconDisciplines {
    abombwe = 'https://static.krcg.org/svg/disc/inf/abo.svg',
    animalism = 'https://static.krcg.org/svg/disc/inf/ani.svg',
    auspex = 'https://static.krcg.org/svg/disc/inf/aus.svg',
    bloodsorcery = 'https://static.krcg.org/svg/disc/inf/tha.svg',
    celerity = 'https://static.krcg.org/svg/disc/inf/cel.svg',
    chimerstry = 'https://static.krcg.org/svg/disc/inf/chi.svg',
    daimoinon = 'https://static.krcg.org/svg/disc/inf/dai.svg',
    dementation = 'https://static.krcg.org/svg/disc/inf/dem.svg',
    dominate = 'https://static.krcg.org/svg/disc/inf/dom.svg',
    fortitude = 'https://static.krcg.org/svg/disc/inf/for.svg',
    melpominee = 'https://static.krcg.org/svg/disc/inf/mel.svg',
    mytherceria = 'https://static.krcg.org/svg/disc/inf/myt.svg',
    necromancy = 'https://static.krcg.org/svg/disc/inf/nec.svg',
    obeah = 'https://static.krcg.org/svg/disc/inf/obe.svg',
    obfuscate = 'https://static.krcg.org/svg/disc/inf/obf.svg',
    obtenebration = 'https://static.krcg.org/svg/disc/inf/obt.svg',
    potence = 'https://static.krcg.org/svg/disc/inf/pot.svg',
    presence = 'https://static.krcg.org/svg/disc/inf/pre.svg',
    protean = 'https://static.krcg.org/svg/disc/inf/pro.svg',
    quietus = 'https://static.krcg.org/svg/disc/inf/qui.svg',
    sanguinus = 'https://static.krcg.org/svg/disc/inf/san.svg',
    serpentis = 'https://static.krcg.org/svg/disc/inf/ser.svg',
    spiritus = 'https://static.krcg.org/svg/disc/inf/spi.svg',
    temporis = 'https://static.krcg.org/svg/disc/inf/tem.svg',
    thanatosis = 'https://static.krcg.org/svg/disc/inf/thn.svg',
    valeren = 'https://static.krcg.org/svg/disc/inf/val.svg',
    vicissitude = 'https://static.krcg.org/svg/disc/inf/vic.svg',
    visceratika = 'https://static.krcg.org/svg/disc/inf/vis.svg',

    defense = 'https://static.krcg.org/svg/disc/inf/def.svg',
    innocence = 'https://static.krcg.org/svg/disc/inf/inn.svg',
    judgment = 'https://static.krcg.org/svg/disc/inf/jus.svg',
    martyrdom = 'https://static.krcg.org/svg/disc/inf/mar.svg',
    redemption = 'https://static.krcg.org/svg/disc/inf/red.svg',
    vision = 'https://static.krcg.org/svg/disc/inf/vin.svg',
    vengeance = 'https://static.krcg.org/svg/disc/inf/ven.svg',

    abombweSup = 'https://static.krcg.org/svg/disc/sup/abo.svg',
    animalismSup = 'https://static.krcg.org/svg/disc/sup/ani.svg',
    auspexSup = 'https://static.krcg.org/svg/disc/sup/aus.svg',
    bloodsorcerySup = 'https://static.krcg.org/svg/disc/sup/tha.svg',
    celeritySup = 'https://static.krcg.org/svg/disc/sup/cel.svg',
    chimerstrySup = 'https://static.krcg.org/svg/disc/sup/chi.svg',
    daimoinonSup = 'https://static.krcg.org/svg/disc/sup/dai.svg',
    dementationSup = 'https://static.krcg.org/svg/disc/sup/dem.svg',
    dominateSup = 'https://static.krcg.org/svg/disc/sup/dom.svg',
    fortitudeSup = 'https://static.krcg.org/svg/disc/sup/for.svg',
    melpomineeSup = 'https://static.krcg.org/svg/disc/sup/mel.svg',
    mytherceriaSup = 'https://static.krcg.org/svg/disc/sup/myt.svg',
    necromancySup = 'https://static.krcg.org/svg/disc/sup/nec.svg',
    obeahSup = 'https://static.krcg.org/svg/disc/sup/obe.svg',
    obfuscateSup = 'https://static.krcg.org/svg/disc/sup/obf.svg',
    obtenebrationSup = 'https://static.krcg.org/svg/disc/sup/obt.svg',
    potenceSup = 'https://static.krcg.org/svg/disc/sup/pot.svg',
    presenceSup = 'https://static.krcg.org/svg/disc/sup/pre.svg',
    proteanSup = 'https://static.krcg.org/svg/disc/sup/pro.svg',
    quietusSup = 'https://static.krcg.org/svg/disc/sup/qui.svg',
    sanguinusSup = 'https://static.krcg.org/svg/disc/sup/san.svg',
    serpentisSup = 'https://static.krcg.org/svg/disc/sup/ser.svg',
    spiritusSup = 'https://static.krcg.org/svg/disc/sup/spi.svg',
    temporisSup = 'https://static.krcg.org/svg/disc/sup/tem.svg',
    thanatosisSup = 'https://static.krcg.org/svg/disc/sup/tha.svg',
    valerenSup = 'https://static.krcg.org/svg/disc/sup/val.svg',
    vicissitudeSup = 'https://static.krcg.org/svg/disc/sup/vic.svg',
    visceratikaSup = 'https://static.krcg.org/svg/disc/sup/vis.svg',
}
